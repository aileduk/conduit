...
const Feed = () => {
  ...
  const numberOfPages =
    Math.ceil(globalArticlesCount / NUMBER_OF_ARTICLES_PER_PAGE) > 0
      ? Math.ceil(globalArticlesCount / NUMBER_OF_ARTICLES_PER_PAGE)
      : 1
      ...
      <div className='grow w-3/4'>
        ...
        <nav className='my-10'>
          <ReactPaginate
            ...
            activeClassName='bg-green-500 text-white underline'
